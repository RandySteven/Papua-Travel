                    ...
                    <x-dropdown>
                        <x-slot name="trigger">
                            <button class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                                <div class="pt-6">Culture</div>
                            </button>
                        </x-slot>

                        <x-slot name="content">
                            <x-dropdown-link :href="route('tradition.index')" :active="request()->routeIs('tradition.index')">Tradition</x-dropdown-link>
                            <x-dropdown-link :href="route('place.index')" :active="request()->routeIs('place.index')">Travel Place</x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
                    <x-nav-link :href="route('restaurant.index')" :active="request()->routeIs('restaurant.index')">Restaurant</x-nav-link>
                </div>
            </div>
                            ...
                            <div class="mr-5">
                                @auth
                                    ...
                                    <a href="{{ route('booking.index') }}">
                                        <img src="/images/reservation.png" class="w-10" alt="Book">
                            ...
                            <div class="mr-5">
                                @auth
                                    @if (Auth::user()->carts()->count()!=0)
                                        <a href="{{ route('carts') }}">
                                            <img src="/images/shopping-cart.png" class="w-10" alt="Cart">
                                            <b class="rounded-full bg-yellow-500 px-2">
                    ...
                    <x-slot name="content">
                        ...
                        @auth
                            @if (Auth::user()->hasRole('admin'))
                                <x-dropdown-link :href="route('hotel.create')">Add Hotel</x-dropdown-link>
                                <x-dropdown-link :href="route('restaurant.create')">Add Restaurant</x-dropdown-link>
