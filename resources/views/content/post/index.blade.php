                                  ...
                                  <div class="flex flex-col ">
                                    <div class="">
                                      <div class="relative h-62 w-full mb-3">
                                        ...
                                        <img src="{{ asset('storage/'.$post->image) }}" alt="Just a flower" class=" w-full   object-fill  rounded-2xl">
                                      </div>
                                      <div class="flex-auto justify-evenly">
                                        <div class="flex flex-wrap ">
                                          ...
                                          <div class="flex items-center w-full justify-between min-w-0 ">
                                            <h2 class="text-lg mr-auto cursor-pointer text-gray-200 hover:text-purple-500 truncate ">{{ $post->name }}</h2>
                                            <div class="flex items-center bg-green-400 text-white text-xs px-2 py-1 ml-3 rounded-lg">
                                              INSTOCK</div>
                                          </div>
                                        </div>
                                        <div class="text-xl text-white font-semibold mt-1">Rp {{ number_format($post->price, 2) }}</div>
                                          ...
                                          <div class="flex-1 inline-flex items-center mb-3">
                                            ...
                                            <div class="cursor-pointer text-gray-400 ">
                                                @foreach ($post->places as $place)
                                                    <span class="hover:text-purple-500 p-1 py-0">{{ $place->place_name }}</span>
                                                @endforeach
                                            </div>
                                          </div>
                                        </div>
