                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('place.store') }}" class="w-full" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group my-2">
                            ...
                            <input type="text" name="place_name" id="place_name" class="w-full rounded @error('place_name') border-red-600 @enderror">
                            @error('place_name')
                        ...
                        <div class="form-group my-2">
                            ...
                            <textarea name="place_location" class="w-full rounded @error('place_location') border-red-600 @enderror" id="" rows="5"></textarea>
                        ...
                        <div class="form-group my-2">
                            ...
                            <textarea name="place_description" class="w-full rounded @error('place_description') border-red-600 @enderror" id="" rows="5"></textarea>
