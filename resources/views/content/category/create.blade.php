                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('category.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group my-2">
                            ...
                            <input type="text" name="category" id="category" class="w-full rounded">
                        </div>
                        <div class="form-group my-2">
                        ...
                        <div class="form-group my-2">
                            ...
                            <textarea name="category_description" id="category_description" rows="5" class="w-full rounded"></textarea>
                        </div>
                        <div class="form-group my-2">
